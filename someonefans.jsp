...
<body>
	...
	<div style="background: #FFFFFF; color: #000000;">
		<ul class="nav nav-tabs nav-pills center-block">
			...
			<c:if test="${requestScope.acct.id == sessionScope.login}">
				<li role="presentation" onclick="loadModifyEdit();"><button class="button button-glow editbuttun button-border button-rounded button-primary"><font
				...
				<c:forEach var="userMap" items="${requestScope.users }">
					...
					<div class="col-sm-4 col-md-4 peopleInfo">
						<div class="thumbnail">
							...
							<div class="row descriptionContext">
								<font size="4px" class="center-block"><strong><c:out
	...
	<script>
		function loadModifyEdit() {
			...
			xmlhttp.open("GET", "ajax.do?type=getmodify", true);
			xmlhttp.send();
		}
		function allReturn() {
			var xmlhttp;
			...
			xmlhttp.open("GET", "ajax.do?type=return2before&from=fan", true);
			xmlhttp.send();
		}
	</script>
</body>
