							...
							<tr>
								...
								<td><c:choose>
										<c:when test="${txt.originalBlah.id == sessionScope.login }">
											<div class="manifest">
												<a
													href='delete.do?message=${txt.originalBlah.date.time}&from=search'
												...
												<tbody>
													<tr>
														<td data-toggle="modal" data-target="#myWeipoModal"
															onclick="loadXMLDoc('${txt.originalBlah.id}','${txt.originalBlah.date.time}'); loadComment('${txt.originalBlah.id}','${txt.originalBlah.date.time}');
																loadCommentEdit('${sessionScope.login}','${txt.originalBlah.id}','${txt.originalBlah.date.time}');">
															<img src="image/ic_reply_black_18dp_2x.png" width="25px">&nbsp;|&nbsp;
														</td>
														<td data-toggle="modal" data-target="#myWeipoModal"
															onclick="loadXMLDoc('${txt.originalBlah.id}','${txt.originalBlah.date.time}'); loadRepostEdit('${sessionScope.login}','${txt.originalBlah.id}','${txt.originalBlah.date.time}');">
															<img src="image/ic_cached_black_18dp_2x.png" width="25px">
															&nbsp;|&nbsp;
														</td>
														<td><img src="image/ic_star_border_black_18dp_2x.png"
															width="25px"
															onclick="doCollect('${txt.originalBlah.id}','${txt.originalBlah.date.time}');"
															id="collectionSignal"> &nbsp;|&nbsp;</td>
														<td><img
															src="image/ic_favorite_border_black_18dp_2x.png"
															id="favourSignal" width="25px"
															onclick="doFavour('${txt.originalBlah.id}','${txt.originalBlah.date.time}');"></td>
													</tr>
												</tbody>
											</table>
										</c:otherwise>
